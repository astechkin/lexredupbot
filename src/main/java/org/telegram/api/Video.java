...
public class Video {
    ...
    String file_id; //Unique identifier for this file
    ...
    PhotoSize thumb; //Optional. Video thumbnail
    String mime_type; //Optional. Mime type of a file as defined by sender
